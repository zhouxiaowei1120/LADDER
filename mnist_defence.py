'''
@Author: Dave Zhou
@Date: 2020-08-25 16:55:19
@LastEditors: Dave Zhou
@LastEditTime: 2020-08-25 16:55:19
@Description: 
@Reference: 
'''
...
class defense_dataset(data.Dataset):
    def __init__(self, data_dir, eps, fgsm=False, transform=None):
        self.filenames = []
        self.ori_filenames = []
        self.fgsm = fgsm
...
class defense_test_dataset(data.Dataset):
    def __init__(self, data_dir, eps, ohter_attack=False, transform=None):
        self.filenames = []
...
if __name__ == '__main__':
    if not os.path.exists('./experiments/mnist_defence/'):
        os.makedirs('./experiments/mnist_defence/') 
    main()
